...
&cmd`system`fmt [u(cobj,core)]=[align(<15 5 20 [strfunc(sub,80 16 6 21)],%0,[u(install`%0`ver)],[timefmt($M/$D/$Y $H:$02F$p,[u(install`%0`date)])],[get([u(install`core)]/system`desc)])]
...
&run`install`main [u(Cobj,core)]=@check [not([gtm([setr(ins,[u(gconfig,%#,SYSTEMS)])],[ucstr(%0)],|)])]={@attach %!/msg`error={The "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" module is already installed.}};@check [isdbref([u(cobj,%0)])]={@attach %!/msg`error={The code object for the module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" is not found.}};&config`systems`current [u(cobj,Gcs)]=[insert(%q<ins>,[inc(words(%q<ins>,|))],[ucstr(%0)],|,|)];&install`%0 [u(cobj,bbk)]=[u(cobj,%0)];&install`%0`date [u(cobj,bbk)]=[secs()];&install`%0`ver [u(cobj,bbk)]=%1;@attach %!/msg={You have installed the "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" version "[ansi([u(gconfig,%#,Line_text)],%1)]" module.};@attach %!/msg`chan={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" version "[ansi([u(gconfig,%#,Line_text)],%1)]" has been installed.}

&run`install`update [u(cobj,core)]=@check [gtm([setr(ins,[u(gconfig,%#,SYSTEMS)])],[ucstr(%0)],|)]={@attach %!/msg`error={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" is not installed.}};&install`%0`date [u(cobj,bbk)]=[secs()];&install`%0`ver [u(cobj,bbk)]=%1;@attach %!/msg={You have updated the module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" to version "[ansi([u(gconfig,%#,Line_text)],%1)]" module.};@attach %!/msg`chan={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" to version "[ansi([u(gconfig,%#,Line_text)],%1)]" module has been updated.}

&run`install`remove [u(cobj,core)]=@check [gtm([setr(ins,[u(gconfig,%#,SYSTEMS)])],[ucstr(%0)],|)]={@attach %!/msg`error={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" is not installed.}};&config`systems`current [u(cobj,gcs)]=[remove(%q<ins>,[ucstr(%0)],|)];&install`%0 [u(cobj,bbk)];&install`%0`ver [u(cobj,bbk)];&install`%0`date [u(cobj,bbk)];@attach %!/msg={You have uninstalled the "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" module.};@attach %!/msg`chan={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" has been uninstalled.}
