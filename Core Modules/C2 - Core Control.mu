...
&run`install`main [u(Cobj,core)]=@check [gte(words(%0),1)]={@attach %!/msg`error={You must supply something to install.}};@check [not([gtm([setr(ins,[u(gconfig,%#,SYSTEMS)])],[ucstr(%0)],|)])]={@attach %!/msg`error={The "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" module is already installed.}};@check [isdbref([u(cobj,%0)])]={@attach %!/msg`error={The code object for the module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" is not found.}};&config`systems`custom [u(cobj,Gcs)]=[insert(%q<ins>,[inc(words(%q<ins>,|))],[ucstr(%0)],|,|)];&install`%0 [u(cobj,bbk)]=[u(cobj,%0)];&install`%0`date [u(cobj,bbk)]=[secs()];&install`%0`ver [u(cobj,bbk)]=%1;@attach %!/msg={You have installed the "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" version "[ansi([u(gconfig,%#,Line_text)],%1)]" module.};@attach %!/msg`chan={Module "[ansi([u(gconfig,%#,Line_text)],[ucstr(%0)])]" version "[ansi([u(gconfig,%#,Line_text)],%1)]" has been installed.}
